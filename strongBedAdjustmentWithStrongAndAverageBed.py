...
# calculates the "Strong Bed Adjustment" Value from inputs and rules.

sb = float(input("Enter Strongest Bed >"))
ab = float(input("Enter Average Bed >"))

sbd = sb - ab #float(input("Enter Strong Bed Difference >"))
